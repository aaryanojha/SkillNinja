...
<div class="container">
    <h1>Account</h1>
    <hr>
    <p> <h4><i class="fa fa-address-card-o" style="font-size:24px"></i> General Information</h4>
          UserID:&emsp; &emsp;&emsp;<?php echo "".$_SESSION['u_id'].""; ?><br><br>
          FullName:&emsp;&nbsp;&nbsp; <?php echo "".$_SESSION['fname'].""; ?><br><br>
          Username:&emsp; <?php echo "".$_SESSION['username'].""; ?><br><br>
          Email:&emsp; &emsp; &emsp;<?php echo "".$_SESSION['fname'].""; ?><br><br>
    </p>
